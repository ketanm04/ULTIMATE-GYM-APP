    ...
    return (
        <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
            ...
            <div className='flex flex-col'>
                ...
                {/*Converts an array into a string, separating elements with the specified delimiter (& in this case).
                 ['a', 'b', 'c'].join(' & ') // Output: "a & b & c" */}

            </div>

            <div className='flex flex-col bg-slate-950 rounded gap-2 '>
                {exercise.description.split('___').map((val) => {        //split turns our given para data into array components sep by __
                    return (
